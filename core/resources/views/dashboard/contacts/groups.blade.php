                        ...
                        <div class="row-row">
                            <div class="col-sm-9 p-a-0">
                                ...
                                <ul class="list">
                                    ...
                                    ?>
                                    <li class="marginBottom5"><a href="{{ route('contacts') }}" {!! $group_id == '' ? " style='font-weight: bold;color:#e91e63'" : '' !!}>
                                    ...
                                    @foreach ($ContactsGroups as $ContactsGroup)
                                        <li class="marginBottom5"
                                            ...
                                            <a href="{{ route('contacts', ['group_id' => $ContactsGroup->id]) }}"
                                                {!! $ContactsGroup->id == $group_id ? " style='font-weight: bold;color:#e91e63'" : '' !!}> {!! $ContactsGroup->name !!}
                                    ...
                                    <li class="marginBottom5"><a {!! $group_id == 'wait' ? " style='font-weight: bold;color:#e91e63'" : '' !!}
                                    ...
                                    <li>
                                        <a {!! $group_id == 'blocked' ? " style='font-weight: bold;color:#e91e63'" : '' !!}
